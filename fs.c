...
struct dirent *readdir(DIR *dirp) {
  ...
  if (b) {
    ...
    strncpy(dirp->dirent.d_name, fdfile.cFileName,
...
char *realpath(const char *restrict path, char *restrict resolved_path) {
  ...
  * Each of these functions returns a pointer to a buffer
    ...
    created absolute path name (absPath) is greater than maxLength), the
...
int copy_file(const char *pathfrom, const char *pathto) {
  ...
  while (nread = fread(buf, sizeof(char), sizeof buf, fd_from),
         nread >
             0) // lint !e668  (warning -- possibly passing null pointer to
                // function 'fread(void *, size_t, size_t, FILE *)', arg. no. 4)
  {
    char *out_ptr = buf;
    size_t nwritten;
...
char *readfile_core(const char *const path) {
  ...
  /*try*/
  {
    ...
    const int mem_size_bytes =
        sizeof(char) * info.st_size + 3 /*BOM*/ + 1 /* \0 */;
...
static const char *file_string_h =
    ...
    "static __inline errno_t memcpy_s(void* const _Destination, rsize_t const "
    "_DestinationSize, void const* const _Source, rsize_t const _SourceSize);\n"
    "static __inline errno_t memmove_s(void* const _Destination, rsize_t const "
    "_DestinationSize, void const* const _Source, rsize_t const _SourceSize);\n"
    ...
    "errno_t wcscat_s(wchar_t* _Destination, rsize_t _SizeInWords, wchar_t "
    "const* _Source);\n"
    "errno_t wcscpy_s(wchar_t* _Destination, rsize_t _SizeInWords, wchar_t "
    "const* _Source);\n"
    "errno_t wcsncat_s(wchar_t* _Destination, rsize_t _SizeInWords, wchar_t "
    "const* _Source, rsize_t _MaxCount);\n"
    "errno_t wcsncpy_s(wchar_t* _Destination, rsize_t _SizeInWords, wchar_t "
    "const* _Source, rsize_t _MaxCount);\n"
    "wchar_t* wcstok_s(wchar_t* _String, wchar_t const* _Delimiter, wchar_t** "
    "_Context);\n"
    "wchar_t* _wcsdup(wchar_t const* _String);\n"
    "wchar_t* wcscat(wchar_t* _Destination, wchar_t const* _Source); int "
    "wcscmp(wchar_t const* _String1, wchar_t const* _String2);\n"
    "wchar_t* wcscpy(wchar_t* _Destination, wchar_t const* _Source); size_t "
    "wcscspn(wchar_t const* _String, wchar_t const* _Control);\n"
    "size_t wcslen(wchar_t const* _String);\n"
    "size_t wcsnlen(wchar_t const* _Source, size_t _MaxCount);\n"
    "static __inline size_t wcsnlen_s(wchar_t const* _Source, size_t "
    "_MaxCount);\n"
    "wchar_t* wcsncat(wchar_t* _Destination, wchar_t const* _Source, size_t "
    "_Count);\n"
    "int wcsncmp(wchar_t const* _String1, wchar_t const* _String2, size_t "
    "_MaxCount);\n"
    "wchar_t* wcsncpy(wchar_t* _Destination, wchar_t const* _Source, size_t "
    "_Count);\n"
    "wchar_t* wcspbrk(wchar_t const* _String, wchar_t const* _Control);\n"
    "size_t wcsspn(wchar_t const* _String, wchar_t const* _Control);\n"
    "wchar_t* wcstok(wchar_t* _String, wchar_t const* _Delimiter, wchar_t** "
    "_Context);\n"
    "size_t wcsxfrm(wchar_t* _Destination, wchar_t const* _Source, size_t "
    "_MaxCount);\n"
    ...
    "int wcsnicmp(wchar_t const* _String1, wchar_t const* _String2, size_t "
    "_MaxCount);\n"
    ...
    "void* _memccpy(void* _Dst, void const* _Src, int _Val, size_t "
    "_MaxCount);\n"
    ...
    "int strnicmp(char const* _String1, char const* _String2, size_t "
    "_MaxCount);\n"
...
static const char *file_stdlib_h =
    ...
    "int base);\n"
    "unsigned long int strtoul(const char* restrict nptr, char** restrict "
    "endptr, int base);\n"
...
#else
char *read_file(const char *path) { return readfile_core(path); }
#endif
