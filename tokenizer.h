...
void token_list_insert_after(struct token_list *list, struct token *after,
                             struct token_list *obj_owner append);
struct token_list tokenizer(struct tokenizer_ctx *p, const char *text,
                            const char *filename_opt, int level,
                            enum token_flags addflags);
