...
struct constant_value constant_value_op(const struct constant_value *a,
                                        const struct constant_value *b, int op);
...
struct expression {
  ...
  struct compound_statement *owner
      compound_statement; // function literal (lambda)
  ...
  struct argument_expression_list
      argument_expression_list; // este node eh uma  chamada de funcao
