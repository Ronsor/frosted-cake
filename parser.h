...
void print_declaration_specifiers(struct osstream *ss,
                                  struct declaration_specifiers *p);
struct declaration_specifiers *owner
declaration_specifiers(struct parser_ctx *ctx,
...
struct enum_specifier {
  /*
   ...
   opt  { enumerator-list } "enum" attribute-specifier-sequence opt identifier
   opt enum-type-specifier opt  { enumerator-list , } "enum" identifier
   enum-type-specifier opt
  */
...
struct member_declaration_list
member_declaration_list(struct parser_ctx *ctx,
                        struct struct_or_union_specifier *);
...
struct struct_or_union_specifier {
  /*
   struct-or-union-specifier:
     struct-or-union attribute-specifier-sequence opt identifier opt {
   member-declaration-list } struct-or-union attribute-specifier-sequence opt
   identifier
  */
  struct attribute_specifier_sequence *owner attribute_specifier_sequence_opt;
...
struct struct_or_union_specifier *view get_complete_struct_or_union_specifier(
    struct struct_or_union_specifier *p_struct_or_union_specifier);
...
struct declarator {
  ...
  */
  ...
  struct declaration_specifiers *view
      declaration_specifiers; // aponta para este cara
...
struct declarator;
void print_declarator(struct osstream *ss, struct declarator *declarator,
                      bool is_abstract);
...
declarator(struct parser_ctx *ctx,
           ...
           bool abstract_acceptable, struct token **pptokenname);
...
struct member_declaration {
  /*
   ...
   member-declarator-list opt ; static_assert-declaration
  */
  struct specifier_qualifier_list *owner specifier_qualifier_list;
...
struct member_declaration *owner
member_declaration(struct parser_ctx *ctx, struct struct_or_union_specifier *);
...
struct member_declarator_list *owner member_declarator_list(
    struct parser_ctx *ctx, struct struct_or_union_specifier *,
    struct specifier_qualifier_list *specifier_qualifier_list);
